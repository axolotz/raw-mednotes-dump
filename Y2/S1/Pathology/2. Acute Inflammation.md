...
3. **Killing and degradation**
    * active process of degradation and intracellular killing is done by the neutrophil bactericidial system
    ...
    * Nitric Oxide is a soluble gas produced from Arginine by NOS (nitric oxide synthase)
        ...
        * iNOS is responsible for intracellular killing stimulated by interferon-γ (IFN-γ)
...
|:--:|:--:|
| *phagocytosis of a bacterium, notice how a lysosome fuses with the phagosome*|*neutrophil engulfing thrush fungus (SEM)*|
...
<!-- -->
* NETs play a major role in the pathogenesis of spesis
* Maybe involved in SLE (Systemic Lupus Erythematosus)
    * disease affects young females, causes rash on cheeks
    * multisystem autoimmune disease

|![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Neutrophil_Extracellular_Trap.jpg/1200px-Neutrophil_Extracellular_Trap.jpg?20210506145752)|
|:--:|
|*neutrophil extracellular trap (green) trapping cells (orange)*|
